    ...
    Tables: {
      ...
      leave_requests: {
        Row: {
          ...
          dates: string[];
          reason: string;
          status: "pending" | "approved_executive" | "approved" | "rejected" | "cancelled";
          ...
          executive_status: "pending" | "approved" | "rejected" | null;
          executive_approved_by: string | null;
          executive_approved_by_name: string | null;
          ...
          rejection_stage: "executive" | "hr" | null;
      ...
      kpis: {
        Row: {
          ...
          type: "result" | "activity" | "quality" | "lead_tim" | "hr";
          unit: string;
          period: string;
